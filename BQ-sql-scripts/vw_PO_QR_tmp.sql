...
SELECT
	...
	CONCAT(
		CASE
			WHEN FORMAT_DATE('%a', BizDate) = 'Sun' THEN '07'
			WHEN FORMAT_DATE('%a', BizDate) = 'Mon' THEN '01'
			WHEN FORMAT_DATE('%a', BizDate) = 'Tue' THEN '02'
			WHEN FORMAT_DATE('%a', BizDate) = 'Wed' THEN '03'
			WHEN FORMAT_DATE('%a', BizDate) = 'Thu' THEN '04'
			WHEN FORMAT_DATE('%a', BizDate) = 'Fri' THEN '05'
			WHEN FORMAT_DATE('%a', BizDate) = 'Sat' THEN '06'
		END,
		'.',
		FORMAT_DATE('%a', BizDate)
