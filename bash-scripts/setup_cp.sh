...
RECIPIENT_EMAIL="yanzhe@cloud-space.co"
CC_EMAILS="wilken@cloud-space.co, amanda@cloud-space.co"
SENDER_EMAIL="yanzhe@cloud-space.co"
EMAIL_SUBJECT="Alert: exapp_pipeline_prod.py failed"
SMTP_SERVER="smtp.gmail.com"
SMTP_PORT=587
SMTP_USER="yanzhe@cloud-space.co"
SMTP_PASSWORD="input manually here" # REMEMBER TO ADD PASSWORD HERE
